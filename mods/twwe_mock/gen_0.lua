...
local action_folder_names = dofile_once( "mods/The-Focus/files/actions/action_folder_names.lua" )
for _, action_folder_name in ipairs( action_folder_names ) do
	...
	action.mod         = "The-Focus"
	action.author      = "Shug"
	if not action.sprite then
		local icon = PATH .. "icon.png"
		action.sprite = ModDoesFileExist( icon ) and icon or "mods/The-Focus/files/actions/default_icon.png"
	end
